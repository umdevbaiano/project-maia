        ...
        <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-500 dark:text-zinc-400 text-sm">Plataforma Jurídica Inteligente</p>
                </div>
                ...
                <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl border border-gray-200 dark:border-zinc-800 rounded-2xl p-8 shadow-2xl">
                    <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Entrar na sua conta</h2>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 dark:bg-zinc-800/50 border border-gray-300 dark:border-zinc-700 rounded-lg pl-11 pr-4 py-3 text-gray-900 dark:text-zinc-100 placeholder-gray-400 dark:placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                                    disabled={isLoading}
                                />
                            </div>
                        </div>
